...
-- colorscheme {{{
--require('scheme/ayu')
--require('scheme/solarized')
--require('scheme/dracula')

--require('scheme/tokyonight')
--require('scheme/tokyodark')

--require('scheme/nightfox')
--require('scheme/catppuccin')
--require('scheme/nord')
--require('scheme/material')
--require('scheme/onedark')
...
--vim.cmd.colorscheme "hybrid"
--
--vim.cmd.colorscheme "256_noir" -- red
...
--require('plugin/.tmp/neotree') -- NeoTree
--require('plugin/.tmp/notify') -- notification manager
