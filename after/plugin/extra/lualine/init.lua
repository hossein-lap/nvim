...
config.options.theme = {
	normal = {
		a = { fg = color.blue,   bg = color.black,  gui = 'none' },
		b = { fg = color.orange, bg = color.black,  gui = 'none' },
		c = { fg = color.fg,     bg = color.bg,     gui = 'none' },

		x = { fg = color.fg,     bg = color.bg,     gui = 'none' },
		y = { fg = color.blue,   bg = color.black,  gui = 'none' },
		z = { fg = color.black,  bg = color.blue,   gui = 'none' },
	},
	insert = {
		a = { fg = color.green,  bg = color.black,  gui = 'none' },
		b = { fg = color.orange, bg = color.black,  gui = 'none' },
		c = { fg = color.fg,     bg = color.bg,     gui = 'none' },
	...
	visual = {
		a = { fg = color.yellow, bg = color.black,  gui = 'none' },
		b = { fg = color.orange, bg = color.black,  gui = 'none' },
		c = { fg = color.fg,     bg = color.bg,     gui = 'none' },

		x = { fg = color.fg,     bg = color.bg,     gui = 'none' },
		y = { fg = color.yellow, bg = color.black,  gui = 'none' },
		z = { fg = color.black,  bg = color.yello,  gui = 'none' },
	},
	replace = {
		...
		z = { fg = color.black,  bg = color.red,    gui = 'none' },
	},
	command = {
		a = { fg = color.purple, bg = color.black,  gui = 'none' },
		b = { fg = color.orange, bg = color.black,  gui = 'none' },
		c = { fg = color.fg,     bg = color.bg,     gui = 'none' },

		x = { fg = color.fg,     bg = color.bg,     gui = 'none' },
		y = { fg = color.purple, bg = color.black,  gui = 'none' },
		z = { fg = color.black,  bg = color.purple, gui = 'none' },
	},
	inactive = {
