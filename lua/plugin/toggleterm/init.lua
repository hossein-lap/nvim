...
-- vim.keymap.set('n', '<localleader>f1', ":lua TermW('run')<CR>")
-- vim.keymap.set('n', '<localleader>f2', ":lua TermW('compile')<CR>")
-- vim.keymap.set('n', '<localleader>f3', ":lua TermW('extra')<CR>")
-- vim.keymap.set('n', '<localleader>tv', ':lua TermV("dash %")<CR>')
-- vim.keymap.set('n', '<localleader>th', ':lua TermH(string.format("echo %s", vim.bo.file))<CR>')
vim.keymap.set('n', '<localleader>ts', ':lua TermF("bash")<CR>')
