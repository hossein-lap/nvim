require("tokyonight").setup({
	...
	day_brightness = 0.3,
	-- Enabling this option, will hide inactive statuslines
		-- and replace them with a thin border instead. Should work with
	...
	--- You can override specific color groups to
		-- use other groups or a hex color
